...
/**
 * A visitor that does nothing. Can be used as a base class when only a few
 * node types need to be processed.
 * @param <A> The type of the additional parameter passed to each visit method
 */
public class EmptyVisitor<A> implements VoidVisitor<A>
{
